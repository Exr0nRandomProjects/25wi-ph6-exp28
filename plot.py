...
def plot_fit_res(xyo, title='', xlabel='', ylabel='', fn=None, fn0=None, fname=None, residual_kwargs={}):
    ...
    if fn is not None:
        ...
        fig2, ax = plot_residuals(fig2, ax, xyo, fn, title='Residuals', xlabel=xlabel, ylabel=None, **residual_kwargs)
